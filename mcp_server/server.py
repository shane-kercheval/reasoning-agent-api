"""
Remote MCP Server using FastMCP 2.0.

This server provides tools via HTTP using pure FastMCP 2.0 framework.
Currently includes fake data implementations for testing.
"""
...
# Initialize FastMCP server - this IS the web server
mcp = FastMCP("reasoning-agent-tools")
    ...
    fake_results = [
        {
            ...
            "snippet": f"Comprehensive information about {query}. This article covers the latest developments and provides in-depth analysis of {query}...",  # noqa: E501
            "date": "2025-07-12",
            "source": "Example News",
        },
        {
            ...
            "snippet": f"Recent news about {query} shows significant developments. According to experts, {query} has been trending due to...",  # noqa: E501
            "date": "2025-07-11",
            "source": "Tech Today",
        },
        {
            ...
            "snippet": f"This comprehensive guide explains {query} in detail, covering all aspects from basics to advanced topics...",  # noqa: E501
            "date": "2025-07-10",
...
async def filesystem(query: str, path: str = "/documents") -> dict:
    ...
    for i in range(random.randint(2, 5)):
        ...
        fake_files.append({
            ...
            "modified": "2025-07-12",
            "preview": f"This document contains information about {query}. It includes detailed analysis and relevant data...",  # noqa: E501
        })
...
if __name__ == "__main__":
    # Run as HTTP server - FastMCP 2.0 handles everything
