...
def main() -> bool:  # noqa: PLR0915
    ...
    print("   make api")
    print("")
    print("2. (Optional) Start the demo MCP server for tool demos:")
    print("   uv run python mcp_servers/fake_server.py")
    print("")
    print("3. Choose a demo to run:")
    print("   # Basic OpenAI SDK compatibility")
    print("   uv run python examples/demo_openai_sdk.py")
    print("")
    print("   # Simple reasoning demo")
    print("   uv run python examples/demo_reasoning_agent.py")
    print("")
    print("   # Complete demo with MCP tools (recommended)")
    print("   uv run python examples/demo_with_mcp_tools.py")
    print("")
