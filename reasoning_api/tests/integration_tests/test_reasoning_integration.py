...
from reasoning_api.mcp import create_mcp_client, to_tools
...
from reasoning_api.dependencies import ServiceContainer, get_prompt_manager, get_tools
...
class TestReasoningAgentEndToEndWithInMemoryMCP:
    ...
    async def reasoning_agent_with_real_mcp_loading(self, in_memory_mcp_server, tmp_path: Path):  # noqa: ANN001
        ...
        with patch('reasoning_api.mcp.Client', side_effect=create_test_client):
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_with_mcp_weather_tool(self, reasoning_agent_with_mcp_tools) -> None:  # noqa: ANN001
    ...
    @pytest.mark.asyncio
    async def test_tool_execution_verification_with_mcp(self, reasoning_agent_with_mcp_tools) -> None:  # noqa: ANN001
    ...
    @pytest.mark.asyncio
    async def test_full_api_flow_with_mcp_loading(self, reasoning_agent_with_real_mcp_loading) -> None:  # noqa: ANN001
    ...
    @pytest.mark.asyncio
    async def test_streaming_with_mcp_loaded_tools(self, reasoning_agent_with_real_mcp_loading) -> None:  # noqa: ANN001
...
class TestAPIWithMCPServerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_api_loads_tools_from_mcp_server(self, mcp_server_for_api, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:  # noqa: ANN001, E501
        ...
        with patch('reasoning_api.mcp.Client', create_test_client):
            ...
            with patch('reasoning_api.dependencies.settings', test_settings):
                ...
                from reasoning_api import dependencies  # noqa: PLC0415
