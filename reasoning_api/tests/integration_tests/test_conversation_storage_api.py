...
@pytest.mark.asyncio
async def test_invalid_conversation_id__returns_400(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_nonexistent_conversation__returns_404(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_database_unavailable__stateful_request__returns_503(client: AsyncClient) -> None:
