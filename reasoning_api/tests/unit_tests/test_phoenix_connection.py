...
def test__setup_tracing__enabled_but_phoenix_unavailable__raises_exception() -> None:
    """Test that setup_tracing raises exception when Phoenix is unavailable."""
    with patch('reasoning_api.tracing.register') as mock_register:
...
def test__setup_tracing__with_console_export() -> None:
...
def test__get_tracer__returns_tracer() -> None:
...
def test__phoenix_connection__real_service() -> None:
    """
