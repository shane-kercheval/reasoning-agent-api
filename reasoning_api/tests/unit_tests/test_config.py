...
from reasoning_api.dependencies import create_production_http_client
from reasoning_api.config import settings, Settings
...
class TestSettings:
    ...
    def test__default_values__are_production_ready(self) -> None:
    ...
    def test__allowed_tokens__parses_comma_separated_values(self) -> None:
    ...
    def test__allowed_tokens__handles_edge_cases(self) -> None:
    ...
    def test__environment_variables__override_defaults(self) -> None:
    ...
    def test__field_descriptions__are_present(self) -> None:
...
class TestSettingsIntegration:
    ...
    def test__settings_can_be_imported__without_errors(self) -> None:
