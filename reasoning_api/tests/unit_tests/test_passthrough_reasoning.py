...
from reasoning_api.executors.passthrough import PassthroughExecutor
from reasoning_api.openai_protocol import OpenAIChatRequest, parse_sse
...
class TestPassthroughReasoningBuffering:
    ...
    async def test__reasoning_content__buffers_and_emits_event(
        ...
        mock_path = "reasoning_api.executors.passthrough.litellm.acompletion"
