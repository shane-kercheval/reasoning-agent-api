...
import time
import pathlib
from reasoning_api.tools import (
    Tool,
    ToolResult,
    function_to_tool,
...
class TestTool:
    ...
    @pytest.mark.asyncio
    async def test_input_validation_required_fields(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_input_validation_additional_properties(self) -> None:
...
class TestFunctionToTool:
    ...
    def test_basic_function_conversion(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_converted_tool_execution(self) -> None:
...
class TestMockTools:
    ...
    @pytest.mark.asyncio
    async def test_mock_weather_tool(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mock_search_tool(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mock_search_tool_default_params(self) -> None:
...
class TestToolFormatting:
    ...
    def test_format_tool_with_required_params(self) -> None:
    ...
    def test_format_tool_with_optional_params(self) -> None:
    ...
    def test_format_tool_with_defaults(self) -> None:
    ...
    def test_format_tool_no_params(self) -> None:
    ...
    def test_format_tool_prevents_parameter_guessing(self) -> None:
        """
    ...
    def test_format_preserves_all_schema_information(self) -> None:
        """
