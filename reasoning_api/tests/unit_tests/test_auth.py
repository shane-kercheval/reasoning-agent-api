...
from reasoning_api.auth import verify_token, get_configured_token_count
...
class TestAuthFunctions:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__allows_access_when_auth_disabled(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__raises_500_when_no_tokens_configured(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__raises_401_when_no_credentials_provided(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__raises_401_when_invalid_token_provided(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__allows_access_with_valid_token(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test__verify_token__handles_whitespace_in_tokens(self) -> None:
    ...
    def test__get_configured_token_count__returns_correct_count(self) -> None:
...
class TestAuthenticationIntegration:
    ...
    def test__protected_endpoints__require_auth_when_enabled(self) -> None:
    ...
    @respx.mock
    def test__protected_endpoints__allow_access_with_valid_token(self, respx_mock: respx.Router) -> None:
    ...
    @respx.mock
    def test__protected_endpoints__work_when_auth_disabled(self, respx_mock: respx.Router) -> None:
    ...
    def test__invalid_token_format__returns_proper_error(self) -> None:
    ...
    def test__malformed_authorization_header__returns_proper_error(self) -> None:
...
class TestAuthEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test__empty_token_in_list__is_ignored(self) -> None:
    ...
    def test__only_whitespace_tokens__are_filtered_out(self) -> None:
